...
<div class="swpm-edit-profile-form">
    <form autocomplete="off" id="swpm-editprofile-form" name="swpm-editprofile-form" method="post" action="" class="swpm-validate-form">
        ...
        <table>
            ...
            <tr class="swpm-profile-email-row">
                ...
                <td><input type="text" id="email" name="email" size="50" autocomplete="off" class="input-field-appear-like-username" value="<?php echo $email; ?>" readonly /></td>
            </tr>
            <tr class="swpm-profile-password-row">
                <td><label for="password"><?php echo SwpmUtils::_('Password'); ?></label></td>
                <td><input type="password" id="password" value="" size="50" name="password" class="<?php echo $pass_class;?>"  placeholder="<?php echo SwpmUtils::_('Leave empty to keep the current password'); ?>" autocomplete="off" /></td>
            </tr>
            ...
            <tr class="swpm-profile-zipcode-row" <?php apply_filters('swpm_edit_profile_form_zipcode_tr_attributes', ''); ?>>
                <td><label for="address_zipcode"><?php echo SwpmUtils::_('Postcode'); ?></label></td>
