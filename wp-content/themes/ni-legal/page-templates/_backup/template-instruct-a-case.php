					...
					<table class="data-table">
						...
						<tbody class="list">
							...
							<tr>
								...
								<td>
									<a href="mailto:<?php echo $response[$key]->UsernameEmail; ?>"><?php echo $response[$key]->UsernameEmail; ?></a>	
								</td>
								<td class="applicant">
							...
							<?php echo date_format($formattedInstructedDate, 'dS F Y'); ?>
								...
								<?php
									...
									$quoteDate = date_format($formattedQuoteGeneratedDate, 'dS F Y');
								?>
									<span class="no-wr">
										<a href="<?php echo site_url('/instruct-a-case/instruct/'); ?>?brokername=<?php echo $brokerName; ?>&brokeremail=<?php echo $brokerEmail; ?>&brokermemberid=<?php echo $brokerMemberID; ?>&quotetype=<?php echo $quoteType; ?>&clientname&<?php echo $clientName; ?>&quotedate=<?php echo $quoteDate; ?>">Intruct</a>
									</span>
								</td>
							</tr>
							<?php endforeach; ?>
