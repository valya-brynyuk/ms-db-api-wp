...
?>
	...
	<script>
		Cognito.prefill({"BrokerName":"<?php echo $brokerName; ?>","BrokerEmail": "<?php echo $brokerEmail; ?>", "MemberID":"<?php echo $brokerMemberID; ?>", "CaseType":"<?php echo $quoteType; ?>","QuoteDate":"<?php echo $quoteDate; ?>","ClientName":"<?php echo $clientName; ?>"});
	</script>
