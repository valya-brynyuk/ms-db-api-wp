		...
		<div class="page-content">
			...
			<?php endif; ?>
				...
				curl_setopt_array($curl, array(
					CURLOPT_URL => 'https://wnpreprod.focisportal.co.uk/FocisCoreAPI/api/Matter/GetBrokerListing',
				...
				<input name="filter-100-percent" id="filter-100-percent" type="checkbox"><label for="filter-100-percent">Show Completed Cases</label>
					...
					<table class="data-table">
						<thead>
							<tr>
								...
								<th><strong><button class="sort" data-sort="matter-opened-date">Matter Opened Date</button></strong></th>
