...
function theme_styles()  { 
	wp_enqueue_style( 'main', get_template_directory_uri() . '/style.css?v=17' );
}
...
function theme_scripts() {
	...
	wp_register_script('functions_js', get_template_directory_uri().'/dist/all.min.js', array('jquery'),'1.14', true);
